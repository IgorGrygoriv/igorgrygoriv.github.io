window.onload = async function handleApi() {
  ...
  if (myObj.market_data.price_change_24h_in_currency.usd >= 0) {
    document.getElementById("coin-price-change").className = "text-success";
    document.getElementById("coin-price-change").innerHTML =
      "$" + myObj.market_data.price_change_24h_in_currency.usd.toFixed(2);
  } else {
    document.getElementById("coin-price-change").className = "text-danger";
    document.getElementById("coin-price-change").innerHTML =
      "$" + myObj.market_data.price_change_24h_in_currency.usd.toFixed(2);
  }
  ...
  if (myObj.market_data.price_change_percentage_7d >= 0) {
    document.getElementById("coin-price-change-7d").className = "text-success";
    document.getElementById("coin-price-change-7d").innerHTML =
      myObj.market_data.price_change_percentage_7d.toFixed(2) + "%";
  } else {
    document.getElementById("coin-price-change-7d").className = "text-danger";
    document.getElementById("coin-price-change-7d").innerHTML =
      myObj.market_data.price_change_percentage_7d.toFixed(2) + "%";
  }
  ...
  document.getElementById("coin-genesis-date").innerHTML = myObj.genesis_date;
  document.getElementById("coin-overview").innerHTML = myObj.description.en;
  document.getElementById("coin-homepage").innerHTML = myObj.links.homepage;
  ...
  document.getElementById("coin-github").href = myObj.links.repos_url.github[0];
